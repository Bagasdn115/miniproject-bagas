...
export default {
    ...
    head() {
      return {
        title: 'Semua Kategori - Soft Store - Pusat Software Berlisensi Resmi',
        meta: [{
            hid: 'og:title',
            name: 'og:title',
            content: 'Semua Kategori - Soft Store - Pusat Software Berlisensi Resmi'
          },
          {
            hid: 'og:site_name',
            name: 'og:site_name',
          ...
          },
          {
            hid: 'description',
            name: 'description',
            content: 'Semua Kategori dari Produk Soft Store'
          },
        ]
      }
    },
