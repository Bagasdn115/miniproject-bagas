...
<script>
  export default {
    ...
    head() {
      return {
        title: 'Cart - Soft Store - Pusat Software Berlisensi Resmi',
        meta: [{
            hid: 'og:title',
            name: 'og:title',
            content: 'Cart - Soft Store - Pusat Software Berlisensi Resmi'
          },
          {
            hid: 'og:site_name',
            name: 'og:site_name',
          ...
          },
          {
            hid: 'description',
            name: 'description',
            content: 'Cart - Official Toko Online Soft Store'
          },
        ]
      }
    },
